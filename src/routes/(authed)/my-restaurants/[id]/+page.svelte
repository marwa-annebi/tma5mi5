...
<div class="flex items-center mt-3 gap-5 ml-10">
	<a href={`/my-restaurants`} class="back-button">
...
<Modal bind:showModal>
	...
	>
		...
		<label class="label">
			...
			<input class="input" type="text" name="name" required placeholder="Menu Name" />
		</label>
		<label class="label">
			<span class="label-text">Description</span>
			<textarea class="textarea" rows="4" name="description" required placeholder="Description"
			></textarea>
		</label>
